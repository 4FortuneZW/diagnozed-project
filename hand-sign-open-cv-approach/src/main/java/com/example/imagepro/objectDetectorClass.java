...
public class  objectDetectorClass {
    ...
    ,String classificationModelParam, int classificationInputSizeParam) throws IOException{
        ...
        classificationInputSize = classificationInputSizeParam;
        // use to define gpu or cpu // no. of threads
        Interpreter.Options options=new Interpreter.Options();
//        gpuDelegate=new GpuDelegate();
//        options.addDelegate(gpuDelegate);
//        options.setNumThreads(4);
        // set it according to your phone
        // loading model
        ...
        interpreter2 = new Interpreter(loadModelFile(assetManager,classificationModelParam), options2);
      ...
      //  float[][][]result=new float[1][10][4];
        ...
        for (int i=0;i<10;i++){
            ...
            if(score_value>0.5){
                ...
                Rect croppped_roi = new Rect((int)x1,(int)y1,(int)w1,(int)h1);
                Mat cropped = new Mat(rotated_mat_image,croppped_roi).clone();
